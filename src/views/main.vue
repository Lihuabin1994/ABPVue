...
<template>
    <div class="main" :class="{'main-hide-text': shrink}">
        ...
        <div class="main-header-con" :style="{paddingLeft: shrink?'80px':'256px'}">
            <div class="main-header">
                <div class="navicon-con">
                  <!-- <a @click="toggleClick" type="text" :class="['sider-trigger-a', collapsed ? 'collapsed' : '']"><Icon type="md-menu" size="26" ></Icon></a> -->
                    <Button  :style="{transform: 'rotateZ(' + (this.shrink ? '-90' : '0') + 'deg)',padding:'10px 15px 6px'}" type="text" @click="toggleClick">
        ...
        <div class="single-page-con" :style="{left: shrink?'80px':'256px'}">
            ...
            <copyfooter :copyright="L('CopyRight.Lhb1994')"></copyfooter>
        </div>
    </div>
</template>
<script lang="ts">
